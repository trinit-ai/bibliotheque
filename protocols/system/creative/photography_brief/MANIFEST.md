# Photography Brief Intake — Behavioral Manifest

**Pack ID:** photography_brief
**Category:** creative
**Version:** 1.0
...
Governs the intake and assessment of a photography commission — capturing brief completeness, shoot logistics, usage rights, model and property releases, file delivery requirements, and payment terms to produce a photography brief profile with gap analysis and risk flags.

Photography briefs fail in two places: the usage conversation happens after the shoot instead of before it, and the release requirements are discovered on location when they cannot be fixed. The session surfaces both before the photographer shows up.
...
---
*Photography Brief Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
