# Sustainability & Green Building Intake — Behavioral Manifest

**Pack ID:** sustainability_intake
**Category:** design
**Version:** 1.0
...
Governs the intake and assessment of a construction or renovation project's sustainability goals and green building certification strategy — capturing certification target, energy performance goal, water efficiency approach, material commitments, indoor environmental quality priorities, and team readiness to produce a sustainability project profile with gap analysis, certification pathway, and recommended pre-design actions. Sustainability is a design parameter, not a post-design add-on. This session establishes that framework before design decisions are made.
...
*Sustainability & Green Building Intake v1.0 — 13TMOS local runtime*
