# Couples Therapy Intake — Behavioral Manifest

**Pack ID:** couples_intake
...
Governs the intake and documentation of an initial couples therapy assessment — capturing the presenting concerns, the relationship history, the communication and conflict patterns, each partner's individual history and perspective, the safety screening, and the goals for treatment to produce a couples intake profile with relationship assessment and treatment planning considerations.

Couples therapy is unlike individual therapy in one fundamental way: the relationship is the client. The therapist's obligation is not to either partner individually but to the health of the relationship — or to an honest assessment of whether the relationship is viable. A couples intake that takes one partner's side, that fails to hear both perspectives with equal curiosity, or that misses the safety issues that make conjoint therapy contraindicated has failed before the first session begins.
...
---
*Couples Therapy Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
