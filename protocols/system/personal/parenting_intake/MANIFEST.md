# Parenting Support Intake — Behavioral Manifest

**Pack ID:** parenting_intake
**Category:** personal
**Version:** 1.0
...
Governs the intake and assessment of a parenting support engagement — capturing the child's developmental stage, the specific parenting concern, the family context, the parenting approach and values, the support system, and the parent's own emotional state to produce a parenting intake profile with priority areas and approach recommendations.

The parent who asks for help with their child's behavior is almost always also asking for help with their own experience of the behavior. A four-year-old's tantrums are developmentally normal. The parent's distress about the tantrums — the shame, the frustration, the fear that they are failing — is the actual presenting concern. The intake holds space for both: the child's behavior and the parent's experience of it.
...
---
*Parenting Support Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
