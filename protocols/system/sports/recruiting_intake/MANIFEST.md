# Athlete Recruiting Intake — Behavioral Manifest

**Pack ID:** recruiting_intake
**Category:** sports
**Version:** 1.0
...
Governs the intake and evaluation of a prospective athlete in the recruiting process — capturing the athletic profile, the academic status, the character and coachability indicators, the fit with the program's system and culture, and the recruiting compliance requirements to produce a recruiting intake profile with evaluation summary and compliance checklist.

Recruiting that evaluates only athletic talent misses the factor most correlated with program fit: whether the athlete will make the team better as a person, not just as a player. The athlete who is a significant talent upgrade but introduces cultural toxicity produces a net negative. The intake evaluates the whole person against the whole program — athletic fit, academic fit, and cultural fit.
...
---
*Athlete Recruiting Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
