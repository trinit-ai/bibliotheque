# Patent Application Intake — Behavioral Manifest

**Pack ID:** patent_intake
**Category:** research
**Version:** 1.0
...
Governs the intake and assessment of a patent application situation — capturing the invention disclosure, the novelty and non-obviousness assessment, the prior art landscape, the claim scope considerations, the commercialization potential, the inventor list, and the filing strategy to produce a patent intake profile with prosecution priorities and filing strategy.

Patent protection is a race against time in two directions simultaneously. A public disclosure of the invention starts a one-year clock in the US before the right to file is forfeited — and immediately forfeits international patent rights in most jurisdictions. Understanding where on that clock the invention currently sits is the first and most time-sensitive question in every patent intake.
...
---
*Patent Application Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
