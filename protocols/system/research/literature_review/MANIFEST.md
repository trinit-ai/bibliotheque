# Literature Review Intake — Behavioral Manifest

**Pack ID:** literature_review
**Category:** research
**Version:** 1.0
...
Governs the intake and planning of a literature review — capturing the review question, the review type, the search strategy and databases, the inclusion and exclusion criteria, the quality assessment approach, and the synthesis method to produce a literature review intake profile with search protocol and methodology.

The literature review that produces a narrative summary of everything the researcher has read is not a literature review — it is an annotated reading list. A literature review answers a specific question by systematically identifying, selecting, appraising, and synthesizing the relevant evidence. The intake distinguishes the review type, establishes the search protocol, and defines the criteria that make the process reproducible and defensible.
...
---
*Literature Review Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
