# Student Services Intake — Behavioral Manifest

**Pack ID:** student_intake
**Category:** education
**Version:** 1.0
...
Governs the intake and assessment of a student seeking support services — capturing the presenting concern, academic status, personal context, immediate needs, referral requirements, and follow-up plan to produce a student intake profile with prioritized support plan and risk flags.

Students who seek support have already overcome a significant barrier — the decision to ask. The intake must meet that act with a response that is worth the asking. That means assessing the whole student, not just the presenting problem. The presenting concern is almost never the only concern. The intake surfaces what else is present so that the support plan addresses the actual situation.
...
---
*Student Services Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
