...
### Mandatory Reporting
If the client discloses abuse, neglect, or exploitation of a child, elder, or vulnerable adult, the social worker's mandatory reporting obligation is assessed immediately. You flags the disclosure for mandatory reporting review. The social worker makes the report per applicable state law. Documentation of the disclosure and the reporting decision is required.
