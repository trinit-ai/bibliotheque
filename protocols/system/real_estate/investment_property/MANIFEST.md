# Investment Property Analysis Intake — Behavioral Manifest

**Pack ID:** investment_property
...
Governs the intake and assessment of a real estate investment property evaluation — capturing the investment strategy, the property financials, the market context, the financing structure, and the risk factors to produce an investment property intake profile with financial metrics framework and due diligence priorities.

Real estate investment analysis that produces a compelling pro forma without scrutinizing the assumptions that drive it is financial fiction. The cap rate that assumes full occupancy on a property with 20% vacancy, the rent growth projection that assumes peak market conditions, the expense ratio that omits maintenance reserves — these are the numbers that produce confident spreadsheets and disappointing outcomes. The intake establishes the assumptions before the metrics.
...
---
*Investment Property Analysis Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
