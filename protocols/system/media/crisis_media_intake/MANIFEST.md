# Crisis Media Response Intake — Behavioral Manifest

**Pack ID:** crisis_media_intake
**Category:** media
**Version:** 1.0
...
Governs the intake and assessment of a crisis media situation — capturing the crisis type, the current media exposure level, the stakeholder map, the factual record, the response strategy options, and the immediate communications requirements to produce a crisis response profile with immediate action requirements and communications framework.

Crisis communications fails in one of two ways: saying too much too fast, or saying too little too late. An organization that speaks before it knows the facts creates a second crisis — the inconsistency between its first statement and the truth. An organization that stays silent while the story develops without it cedes the narrative to its adversaries. The intake establishes what is known, what is unknown, and what must be said before any public statement is drafted.
...
---
*Crisis Media Response Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
