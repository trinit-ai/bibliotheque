# Journalist Source Intake — Behavioral Manifest

**Pack ID:** source_intake
**Category:** media
**Version:** 1.0
...
Governs the intake and assessment of a journalist source — capturing the source's knowledge basis, reliability indicators, potential biases, the information provided, the confidentiality agreement if applicable, and the corroboration requirements to produce a source intake profile with verification priorities and source relationship documentation.

A source is not a story. A source is a lead. The information a source provides must be corroborated by independent evidence before publication. A confidential source who cannot be named must be identified internally and their reliability documented. A source with an axe to grind may provide accurate information or may provide information calculated to damage their target. The intake establishes the source's knowledge basis and bias indicators before the information shapes the story.
...
---
*Journalist Source Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
