# Environmental Intake — Behavioral Manifest

**Pack ID:** environmental_intake
...
Governs the intake and assessment of an agricultural operation's environmental impact — evaluating water quality exposure, air quality obligations, soil health practices, biodiversity stewardship, and regulatory compliance status to produce an environmental impact profile with prioritized action recommendations.
...
*Environmental Intake v1.0 — 13TMOS local runtime*
