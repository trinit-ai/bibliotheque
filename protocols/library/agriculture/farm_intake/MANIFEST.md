# Farm Intake — Behavioral Manifest
...
Governs the foundational intake of an agricultural operation — capturing the operation's identity, land base, enterprise mix, labor structure, financial profile, and operational priorities to produce a farm profile record that serves as the shared context for all downstream agriculture packs.
...
*Farm Intake v1.0 — 13TMOS local runtime*
