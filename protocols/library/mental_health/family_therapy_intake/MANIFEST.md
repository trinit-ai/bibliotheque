# Family Therapy Intake — Behavioral Manifest

**Pack ID:** family_therapy_intake
...
Governs the intake and documentation of an initial family therapy assessment — capturing the presenting concerns, the family composition and structure, the family system dynamics, the developmental context of the identified patient (if applicable), the safety considerations, and the goals for treatment to produce a family therapy intake profile with systemic assessment and treatment planning considerations.

Family therapy sees the symptom as a signal from the system. A child who is acting out is communicating something about the family environment. An adolescent who has withdrawn is responding to something in the relational field. The intake that focuses only on the identified patient — who is usually the person the family presents as "the problem" — misses the systemic context in which the symptom makes sense.
...
---
*Family Therapy Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
