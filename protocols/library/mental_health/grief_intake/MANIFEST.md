# Grief and Bereavement Intake — Behavioral Manifest

**Pack ID:** grief_intake
...
Governs the intake and documentation of a grief and bereavement assessment — capturing the nature of the loss, the grief response, the complicated grief indicators, the support system, the comorbid conditions, and the cultural and spiritual context to produce a grief intake profile with grief response assessment and clinical considerations for the treating clinician.

Grief is not a disorder. It is the appropriate human response to loss. The intake that pathologizes grief — that treats every expression of sorrow as a symptom to be treated — does the bereaved person a disservice. The intake that fails to recognize when grief has become something more — persistent, disabling, complicated — and requires clinical intervention also does them a disservice. The distinction between normal grief and complicated grief is the intake's primary clinical contribution.
...
---
*Grief and Bereavement Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
