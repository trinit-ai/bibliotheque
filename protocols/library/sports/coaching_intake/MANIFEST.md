# Coaching Staff Intake — Behavioral Manifest

**Pack ID:** coaching_intake
**Category:** sports
**Version:** 1.0
...
Governs the intake and assessment of a new coaching staff member — capturing the coaching background and philosophy, sport-specific certifications, athlete safety and safeguarding training, prior program experience, coaching style, and organizational fit to produce a coaching intake profile with onboarding requirements and program fit assessment.

Coaching intake that documents credentials without assessing philosophy produces a file, not a fit assessment. The coach with impressive credentials and a culture that contradicts the program's values will damage the athletes and the program. The intake establishes both competence and character before the coach is in front of athletes.
...
---
*Coaching Staff Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
