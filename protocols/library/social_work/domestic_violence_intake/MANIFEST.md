# Domestic Violence Intake — Behavioral Manifest

**Pack ID:** domestic_violence_intake
...
Governs the intake and assessment of a domestic violence situation — capturing the safety situation, the nature and history of the abuse, the lethality risk, the children and other dependents involved, the client's immediate needs and goals, and the service options to produce a domestic violence intake profile with safety plan and service priorities.

Domestic violence intake begins with the client's safety and the client's goals — not the worker's assessment of what the client should do. A survivor who is not ready to leave is not failing — they are navigating a complex situation with real constraints that the worker may not fully understand. The worker's job is to provide safety information, connect the client to resources, and support the client's own decision-making — not to make the decision for them.
...
---
*Domestic Violence Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
