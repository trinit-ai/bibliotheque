# Donor Engagement Intake — Behavioral Manifest

**Pack ID:** donor_intake
...
Governs the intake and assessment of a donor engagement situation — capturing the donor's interests and connection to the mission, their giving history and capacity, their engagement level and motivations, the relationship history, and the cultivation and ask strategy to produce a donor intake profile with cultivation priorities and ask strategy.

Major donor fundraising fails most often not because the ask was too high but because the relationship was too shallow. A donor who receives a cultivation meeting and an ask in the same year has been treated like an ATM, not a partner. The intake establishes where the donor is in the relationship — and what the organization needs to do before an ask is appropriate.
...
---
*Donor Engagement Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
