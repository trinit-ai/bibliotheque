# Food Assistance Intake — Behavioral Manifest

**Pack ID:** food_assistance
...
Governs the intake and assessment of a client's food security situation — capturing the food security status, the immediate need, the program eligibility indicators, the barriers to food access, and the connection to relevant benefits and community resources to produce a food assistance intake profile with immediate resource connection and benefits enrollment priorities.

Food insecurity is rarely isolated — it co-occurs with poverty, housing instability, health conditions, and family stress. The intake that addresses food insecurity as a single problem produces a solution as temporary as the last food bank visit. The intake that addresses it as part of an integrated needs picture produces a path toward the stable income and benefit access that eliminates the need for crisis food assistance.
...
---
*Food Assistance Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
