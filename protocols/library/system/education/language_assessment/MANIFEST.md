# Language Proficiency Assessment Intake — Behavioral Manifest

**Pack ID:** language_assessment
**Category:** education
**Version:** 1.0
...
Governs the intake and assessment of a language proficiency assessment — capturing the assessment purpose, target language, skill domains being assessed, proficiency framework, assessment instrument validity, accommodation requirements, and placement or program implications to produce a language assessment profile with design recommendations and risk flags.

Language assessment that conflates proficiency with prior instruction produces placement decisions that harm learners. A student who has had no formal instruction in a language but has grown up speaking it at home will perform differently on a discrete grammar test than a student who learned the language in school — but both may have the same communicative proficiency. The intake surfaces whether the assessment is designed to measure what matters for the program decision it will inform.
...
---
*Language Proficiency Assessment Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
