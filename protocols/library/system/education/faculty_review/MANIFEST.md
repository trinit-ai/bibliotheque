# Faculty Performance Review Intake — Behavioral Manifest

**Pack ID:** faculty_review
**Category:** education
**Version:** 1.0
...
Governs the intake and assessment of a faculty performance review — capturing the review purpose, applicable institutional policies, evaluation criteria and evidence sources, teaching effectiveness methodology, research and service components, due process requirements, and outcome implications to produce a faculty review profile with process assessment and risk flags.

Faculty reviews produce legally and professionally consequential decisions — tenure, promotion, merit pay, non-renewal, and termination. Defective review processes — inadequate notice, incomplete evaluation criteria, procedurally irregular evidence gathering — can be challenged successfully regardless of the substantive findings. The intake surfaces the procedural gaps before the review is conducted.
...
---
*Faculty Performance Review Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
