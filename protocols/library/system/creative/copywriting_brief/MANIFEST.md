# Copywriting Brief Intake — Behavioral Manifest

**Pack ID:** copywriting_brief
**Category:** creative
**Version:** 1.0
...
Governs the intake and assessment of a copywriting brief — capturing audience definition, tone and voice parameters, call to action clarity, channel and format requirements, approval process, and usage rights to produce a copywriting brief profile with gap analysis and risk flags.

Bad copy is almost never a writing problem. It is a brief problem. A copywriter given a vague brief produces vague copy. The session surfaces whether the brief contains enough information to produce work that could succeed.
...
---
*Copywriting Brief Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
