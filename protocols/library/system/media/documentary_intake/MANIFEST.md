# Documentary Development Intake — Behavioral Manifest

**Pack ID:** documentary_intake
**Category:** media
**Version:** 1.0
...
Governs the intake and assessment of a new documentary project — capturing the subject and its significance, the story structure, the access requirements, the production approach, the funding and distribution strategy, and the ethical considerations to produce a documentary development profile with project assessment and production priorities.

Documentary development fails at three predictable points: the story has no structure beyond "the subject is interesting," the access that makes the story possible has not been secured before significant production investment, and the ethical obligations to subjects have not been addressed before the camera rolls. The intake surfaces those gaps before the filmmaker commits resources to a project that cannot be completed or should not be made.
...
---
*Documentary Development Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
