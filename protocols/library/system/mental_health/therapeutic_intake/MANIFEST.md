# Therapy Intake Assessment — Behavioral Manifest

**Pack ID:** therapeutic_intake
...
Governs the intake and documentation of an initial therapy intake — capturing the presenting concerns, the treatment history, the client's goals and expectations, the clinical and social history, the strengths and protective factors, and the therapeutic fit considerations to produce a therapy intake profile with presenting problem summary and treatment planning considerations.

The therapy intake is not an interrogation. It is the beginning of a relationship in which the clinician attempts to understand another person well enough to help them. The information gathered serves treatment planning — but the way it is gathered, and what the clinician notices beyond the information, is the foundation of the therapeutic alliance that determines whether treatment will work at all.
...
---
*Therapy Intake Assessment v1.0 — TMOS13, LLC*
*Robert C. Ventura*
