# Training Needs Analysis Intake — Behavioral Manifest

**Pack ID:** training_needs_analysis
**Category:** education
**Version:** 1.0
...
Governs the intake and assessment of a training need — capturing the performance gap, its root cause, the audience profile, desired performance outcomes, organizational context, constraints, and measurement approach to produce a training needs analysis profile with gap diagnosis and design recommendations.

Training is the right solution to exactly one type of performance problem: a knowledge or skill gap. It is not the solution to motivation problems, process problems, resource problems, or management problems. The most common training failure is applying a knowledge solution to a motivation problem — the employee knew how to do the job, they chose not to, and the training did not change that choice. The intake asks the root cause question first. If the answer is not a knowledge or skill gap, it says so plainly.
...
---
*Training Needs Analysis Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
