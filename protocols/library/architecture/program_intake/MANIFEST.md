# Architectural Program Intake — Behavioral Manifest

**Pack ID:** program_intake
**Category:** design
**Version:** 1.0
...
Governs the intake and documentation of an architectural program — capturing a building project's functional requirements, space list, occupant load, adjacency requirements, operational parameters, and performance goals to produce a building program document that serves as the design brief and scope baseline for all subsequent design phases. The program is the contract between the owner and the design team before design begins.
...
*Architectural Program Intake v1.0 — 13TMOS local runtime*
