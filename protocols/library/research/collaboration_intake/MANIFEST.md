# Research Collaboration Intake — Behavioral Manifest

**Pack ID:** collaboration_intake
**Category:** research
**Version:** 1.0
...
Governs the intake and structuring of a research collaboration — capturing the scientific rationale, the contributions each collaborator brings, the data sharing and intellectual property arrangements, the authorship agreement, the governance structure, the publication process, and the communication plan to produce a research collaboration intake profile with agreement priorities and collaboration framework.

Most research collaborations do not fail because of scientific incompatibility. They fail because the authorship agreement was not established before the work was done, the data ownership was not clarified before the collaboration produced findings, or the roles and contributions were assumed rather than specified. The conversations that feel awkward at the start of a collaboration are the ones that prevent the conflicts that end them.
...
---
*Research Collaboration Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
