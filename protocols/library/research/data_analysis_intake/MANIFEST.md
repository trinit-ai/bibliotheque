# Research Data Analysis Intake — Behavioral Manifest

**Pack ID:** data_analysis_intake
**Category:** research
**Version:** 1.0
...
Governs the intake and planning of a research data analysis — capturing the data structure and quality, the analytic questions, the methodology, the software environment, the key assumptions, and the reporting and reproducibility requirements to produce a data analysis intake profile with analytic plan and methodology flags.

The most common data analysis failure is not a statistical error — it is a question answered that was not the research question. The analysis that produces a significant p-value for a variable of secondary interest, or that treats a mediation as if it were a direct effect, or that conflates statistical significance with clinical or practical significance, has produced output that misrepresents the findings. The intake establishes what question the analysis is designed to answer before any analysis begins.
...
---
*Research Data Analysis Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
