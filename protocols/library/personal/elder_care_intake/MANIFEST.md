# Elder Care Planning Intake — Behavioral Manifest

**Pack ID:** elder_care_intake
**Category:** personal
**Version:** 1.0
...
Governs the intake and assessment of an elder care planning situation — capturing the elder's current functional status, care needs, medical situation, living situation, financial context, family dynamics, the available resources, and the planning priorities to produce an elder care planning profile with care gap assessment and priority actions.

Elder care planning is almost always reactive — families begin the conversation after a crisis (a fall, a hospitalization, a cognitive decline episode) rather than before one. The intake serves both the reactive situation and the proactive one. For families in crisis: stabilize, assess, and plan. For families planning ahead: identify the gaps and fill them before the crisis makes the choices for them.
...
---
*Elder Care Planning Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
