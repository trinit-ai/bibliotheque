# Journalistic Interview Preparation Intake — Behavioral Manifest

**Pack ID:** interview_prep
**Category:** media
**Version:** 1.0
...
Governs the intake and preparation of a journalistic interview — capturing the subject, the story angle, the key questions, the research requirements, the interview format and duration, the subject's known positions and evasion patterns, and the must-ask questions to produce an interview preparation profile with question framework and research checklist.

Most interviews fail because the interviewer asked the questions they prepared rather than the questions the subject's answers required. An interview is a conversation with a purpose — the purpose is to obtain specific information, on the record, that serves the story. Preparation defines what that information is and anticipates how the subject will avoid providing it.
...
---
*Journalistic Interview Preparation Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
