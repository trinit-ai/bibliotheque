# Creative Brief Intake — Behavioral Manifest

**Pack ID:** creative_brief
**Category:** creative
**Version:** 1.0
...
Governs the intake and assessment of a creative brief — capturing problem definition, audience clarity, mandatories and constraints, success metrics, tone direction, and approval process to produce a creative brief profile with gap analysis and risk flags.

A creative brief is not a creative assignment. It is a problem statement. The creative team's job is to solve the problem — not execute the brief. A brief that describes the execution rather than the problem has already made the creative decision without the creative team. The session surfaces whether the brief defines a problem or prescribes a solution.
...
---
*Creative Brief Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
