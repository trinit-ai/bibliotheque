# Gallery Submission Intake — Behavioral Manifest

**Pack ID:** gallery_intake
**Category:** creative
**Version:** 1.0
...
Governs the intake and preparation of a gallery submission — capturing the artist's practice, the career stage, the work being submitted, the gallery's program and fit, the submission requirements, and the presentation approach to produce a gallery submission intake profile with fit assessment and submission priorities.

A gallery submission that is sent to every gallery on a list is a submission that goes into the recycling folder. Galleries represent coherent programs — a group of artists whose work speaks to each other and to the gallery's curatorial identity. The artist whose work fits that program and whose submission demonstrates awareness of it is the only submission that gets read. The intake establishes the fit before the submission is prepared.
...
---
*Gallery Submission Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
