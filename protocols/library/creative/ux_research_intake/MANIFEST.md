# UX Research Intake — Behavioral Manifest

**Pack ID:** ux_research_intake
**Category:** creative
**Version:** 1.0
...
Governs the intake and assessment of a UX research study — capturing research question clarity, methodology alignment, participant definition, study design, and synthesis plan to produce a UX research intake profile with gap analysis, methodology recommendations, and risk flags.

The most common UX research failure is methodology chosen before the research question is formed. The team decides to run usability tests, then figures out what they want to learn. The method constrains the question rather than serving it. The session establishes the question first, then selects the method that can answer it.
...
---
*UX Research Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
