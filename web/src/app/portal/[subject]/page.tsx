...
const SUBJECT_CARDS: Record<string, CardEntry[]> = {
  ...
  science: [
    { id: "relativity_einstein", title: "On the Electrodynamics of Moving Bodies", author: "Albert Einstein \u00b7 1905", desc: "The original special relativity paper. Thirty pages that dismantled absolute time and planted the seed for E=mc\u00b2.", format: "living_book", meta: "Full text", sessions: "24 this week" },
  ...
  literature: [
    { id: "room_of_ones_own", title: "A Room of One\u2019s Own", author: "Virginia Woolf \u00b7 1929", desc: "What does a woman need in order to write? Five hundred pounds a year and a room with a lock on the door. Not metaphor. Material conditions.", format: "living_book", meta: "~38,000 words", sessions: "18 this week" },
...
export default function PortalSubjectPage() {
  ...
  return (
    <div style={{ background: cream, color: ink, minHeight: "100vh", fontFamily: serif }}>
      ...
      {/* Top bar */}
      <div className="portal-topbar" style={{ background: cream, borderBottom: `0.5px solid ${border_}`, padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 54 }}>
