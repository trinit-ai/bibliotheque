...
function TickerBar() {
  return (
    <Link href="/wiki/getting_started" style={{ textDecoration: "none", display: "flex", background: "#7F1D1D", height: 28, overflow: "hidden", whiteSpace: "nowrap", alignItems: "center", justifyContent: "center", gap: 8, cursor: "pointer", transition: "background .15s" }}
...
const CARD_ENTRIES = [
  ...
  { id: "room_of_ones_own", title: "A Room of One\u2019s Own", author: "Virginia Woolf \u00b7 1929", desc: "What does a woman need in order to write? Five hundred pounds a year and a room with a lock on the door. Not metaphor. Material conditions.", format: "living_book", portal: "literature", meta: "~38,000 words", sessions: "18 this week" },
  { id: "relativity_einstein", title: "On the Electrodynamics of Moving Bodies", author: "Albert Einstein \u00b7 1905", desc: "The original special relativity paper. Thirty pages that dismantled absolute time and planted the seed for E=mc\u00b2.", format: "living_book", portal: "science", meta: "Full text", sessions: "24 this week" },
